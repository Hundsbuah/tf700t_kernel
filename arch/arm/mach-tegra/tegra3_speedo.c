...
static const int cpu_speedo_nominal_millivolts[] = {
      ...
      1350,       /* speedo_id 2 */
      1350,       /* speedo_id 3 */
      HUNDSBUAH_MAX_CPU_VOLTAGE_CAP,       /* speedo_id 4 */
      HUNDSBUAH_MAX_CPU_VOLTAGE_CAP,       /* speedo_id 5 */
      HUNDSBUAH_MAX_CPU_VOLTAGE_CAP,       /* speedo_id 6 */
      1350,       /* speedo_id 7 */
      1150,       /* speedo_id 8 */
      1007,       /* speedo_id 9 */
      916,        /* speedo_id 10 */
      850,        /* speedo_id 11 */
      HUNDSBUAH_MAX_CPU_VOLTAGE_CAP,       /* speedo_id 12 */
      1350,       /* speedo_id 13 */
      950,        /* speedo_id 14 */
      900 };      /* speedo_id 15 */
...
int tegra_core_speedo_mv(void)
{
	...
	case 2:
		if (cpu_speedo_id != 13)
			return HUNDSBUAH_MAX_CORE_VOLTAGE_CAP;
		/* T37 */
		return 1350;
	case 3:
		return 1350;
