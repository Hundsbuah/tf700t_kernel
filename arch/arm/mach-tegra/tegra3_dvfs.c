...
int user_mv_table[MAX_DVFS_FREQS] = {
		637, 650, 662, 675, 700, 712, 725, 737, 750, 762, 775, 787, 800, 825, 837, 850, 862, 875, 887, 900,  912,  925,  937,  950,  975,  987,  1000, 1012, 1037, 1050, 1062, 1075, 1100, 1112, 1125, 1137, 1150, 1175, 1250, HUNDSBUAH_MAX_CPU_VOLTAGE };
#endif
...
static struct dvfs cpu_dvfs_table[] = {
	...
	CPU_DVFS("cpu_g",  5, 3, MHZ,   1,  475, 475, 475, 620, 620, 620, 620, 760, 760, 760, 760,  760,  910,  910,  1000,  1000, 1000, 1000, 1150, 1150, 1150, 1150, 1150, 1300, 1300, 1300, 1300, 1400, 1400, 1400, 1400, 1500, 1500, 1500, 1500, 1500, 1500, 1750, HUNDSBUAH_MAX_CPU_FREQUENCY),
	CPU_DVFS("cpu_g",  5, 4, MHZ,   1,  475, 475, 475, 620, 620, 620, 620, 760, 760, 760, 760,  760,  910,  910,  1000,  1000, 1000, 1000, 1150, 1150, 1150, 1150, 1150, 1300, 1300, 1300, 1300, 1400, 1400, 1400, 1400, 1500, 1500, 1500, 1500, 1500, 1500, 1750, HUNDSBUAH_MAX_CPU_FREQUENCY),

	CPU_DVFS("cpu_g", 12, 3, MHZ,   1,  475, 475, 475, 620, 620, 620, 620, 760, 760, 760, 760,  760,  910,  910,  1000,  1000, 1000, 1000, 1150, 1150, 1150, 1150, 1150, 1300, 1300, 1300, 1300, 1400, 1400, 1400, 1400, 1500, 1500, 1500, 1500, 1500, 1500, 1750, HUNDSBUAH_MAX_CPU_FREQUENCY),
	CPU_DVFS("cpu_g", 12, 4, MHZ,   1,  475, 475, 475, 620, 620, 620, 620, 760, 760, 760, 760,  760,  910,  910,  1000,  1000, 1000, 1000, 1150, 1150, 1150, 1150, 1150, 1300, 1300, 1300, 1300, 1400, 1400, 1400, 1400, 1500, 1500, 1500, 1500, 1500, 1500, 1750, HUNDSBUAH_MAX_CPU_FREQUENCY),
...
static struct dvfs cpu_0_dvfs_table[] = {
	/* Cpu voltages (mV):	      750, 775, 787, 800, 825, 837, 850, 862,  875,  887,  900,  912,  916,  925,  937,  950,  962,  975,  987, 1000, 1007, 1012, 1025, 1037, 1050, 1062, 1075, 1087, 1100, 1112, 1125, 1137, 1150, 1162, 1175, 1187, 1200, 1250, 1300, HUNDSBUAH_MAX_CPU_VOLTAGE}; */
	CPU_DVFS("cpu_0",  5, 3, MHZ, 475, 475, 620, 620, 760, 760, 760, 910,  910,  910, 1000, 1000, 1000, 1000, 1000, 1000, 1150, 1150, 1150, 1150, 1150, 1300, 1300, 1300, 1300, 1400, 1400, 1400, 1400, 1500, 1500, 1500, 1500, 1500, 1600, 1600, 1600, 1600, 1750, HUNDSBUAH_MAX_CPU_FREQUENCY),
	CPU_DVFS("cpu_0",  5, 4, MHZ, 475, 475, 620, 620, 760, 760, 760, 910,  910,  910, 1000, 1000, 1000, 1000, 1000, 1000, 1150, 1150, 1150, 1150, 1150, 1300, 1300, 1300, 1300, 1400, 1400, 1400, 1400, 1500, 1500, 1500, 1500, 1500, 1600, 1600, 1600, 1600, 1750, HUNDSBUAH_MAX_CPU_FREQUENCY),

	CPU_DVFS("cpu_0", 12, 3, MHZ, 475, 475, 620, 620, 760, 760, 760, 910,  910,  910, 1000, 1000, 1000, 1000, 1000, 1000, 1150, 1150, 1150, 1150, 1150, 1300, 1300, 1300, 1300, 1400, 1400, 1400, 1400, 1500, 1500, 1500, 1500, 1500, 1600, 1600, 1600, 1600, 1750, HUNDSBUAH_MAX_CPU_FREQUENCY),
	CPU_DVFS("cpu_0", 12, 4, MHZ, 475, 475, 620, 620, 760, 760, 760, 910,  910,  910, 1000, 1000, 1000, 1000, 1000, 1000, 1150, 1150, 1150, 1150, 1150, 1300, 1300, 1300, 1300, 1400, 1400, 1400, 1400, 1500, 1500, 1500, 1500, 1500, 1600, 1600, 1600, 1600, 1750, HUNDSBUAH_MAX_CPU_FREQUENCY),
};
...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("emc",    2, 1, KHZ,   102000, 450000, 450000, 450000, 450000,  667000,  667000,  900000, 900000),
	...
	CORE_DVFS("vde",    2, 1, KHZ,   200000, 247000, 304000, 352000, 400000,  437000,  484000,  650000, HUNDSBUAH_MAX_CORE_FREQUENCY * 1000 ),
	CORE_DVFS("mpe",    2, 1, KHZ,   200000, 247000, 304000, 361000, 408000,  446000,  484000,  650000, HUNDSBUAH_MAX_CORE_FREQUENCY * 1000 ),
	CORE_DVFS("2d",     2, 1, KHZ,   200000, 267000, 304000, 361000, 408000,  446000,  484000,  650000, HUNDSBUAH_MAX_CORE_FREQUENCY * 1000 ),
	CORE_DVFS("epp",    2, 1, KHZ,   200000, 267000, 304000, 361000, 408000,  446000,  484000,  650000, HUNDSBUAH_MAX_CORE_FREQUENCY * 1000 ),
	CORE_DVFS("3d",     2, 1, KHZ,   200000, 247000, 304000, 361000, 408000,  446000,  484000,  650000, HUNDSBUAH_MAX_CORE_FREQUENCY * 1000 ),
	CORE_DVFS("3d2",    2, 1, KHZ,   200000, 247000, 304000, 361000, 408000,  446000,  484000,  650000, HUNDSBUAH_MAX_CORE_FREQUENCY * 1000 ),
	CORE_DVFS("se",     2, 1, KHZ,   200000, 267000, 304000, 361000, 408000,  446000,  484000,  650000, HUNDSBUAH_MAX_CORE_FREQUENCY * 1000 ),
	CORE_DVFS("host1x", 2, 1, KHZ,   100000, 152000, 188000, 222000, 254000,  267000,  267000,  HUNDSBUAH_MAX_HOST1X_FREQUENCY * 1000, HUNDSBUAH_MAX_HOST1X_FREQUENCY * 1000),
	CORE_DVFS("cbus",   2, 1, KHZ,   200000, 247000, 304000, 352000, 400000,  437000,  484000,  650000, HUNDSBUAH_MAX_CORE_FREQUENCY * 1000 ),
