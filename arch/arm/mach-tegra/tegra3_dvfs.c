...
750,  762,     825,     875,     925,     950,     1000,    1050,    1100,   1212,    1237,    1425 };
#endif
...
static struct dvfs cpu_dvfs_table[] = {
	/* Cpu voltages (mV):	       750,  762,     825,     875,     925,     950,     1000,    1050,    1100,   1212,    1237,    1350 };*/
	CPU_DVFS("cpu_g", 4,  0, MHZ,  1,    475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850 ),
	CPU_DVFS("cpu_g", 4,  1, MHZ,  1,    475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850 ),
	CPU_DVFS("cpu_g", 4,  2, MHZ,  1,    475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850 ),
	CPU_DVFS("cpu_g", 4,  3, MHZ,  1,    475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850 ),

	CPU_DVFS("cpu_g", 5,  3, MHZ,  1,    475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850 ),
	CPU_DVFS("cpu_g", 5,  4, MHZ,  1,    475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850 ),

	CPU_DVFS("cpu_g", 6,  3, MHZ,  1,    475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850 ),
	CPU_DVFS("cpu_g", 6,  4, MHZ,  1,    475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850 ),

	CPU_DVFS("cpu_g", 12, 3, MHZ,  1,    475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850 ),
	CPU_DVFS("cpu_g", 12, 4, MHZ,  1,    475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850 ),
...
static struct dvfs cpu_0_dvfs_table[] = {
	/* Cpu voltages (mV):	       750,  762,     825,     875,     925,     950,     1000,    1050,    1100,   1212,    1237,    1350 };*/
	CPU_DVFS("cpu_0", 4, 0, MHZ,   1,    475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850 ),
	CPU_DVFS("cpu_0", 4, 1, MHZ,   1,    475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850 ),
	CPU_DVFS("cpu_0", 4, 2, MHZ,   1,    475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850 ),
	CPU_DVFS("cpu_0", 4, 3, MHZ,   1,    475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850 ),

	CPU_DVFS("cpu_0", 5, 3, MHZ,   1,    475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850 ),
	CPU_DVFS("cpu_0", 5, 4, MHZ,   1,    475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850 ),

	CPU_DVFS("cpu_0", 6, 3, MHZ,   1,    475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850 ),
	CPU_DVFS("cpu_0", 6, 4, MHZ,   1,    475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850 ),

	CPU_DVFS("cpu_0", 12, 3, MHZ,  1,    475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850 ),
	CPU_DVFS("cpu_0", 12, 4, MHZ,  1,    475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850 ),
};
