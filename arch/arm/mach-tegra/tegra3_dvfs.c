...
762,     825,     875,     925,     950,     1000,    1050,    1100,   1212,    1237,		1375,    HUNDSBUAH_MAX_CPU_VOLTAGE };
#endif
...
static struct dvfs cpu_dvfs_table[] = {
	/* Cpu voltages (mV):	       762,     825,     875,     925,     950,     1000,    1050,    1100,   1212,    1237,		1375,    HUNDSBUAH_MAX_CPU_VOLTAGE }; */
	CPU_DVFS("cpu_g", 4,  0, MHZ,  475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850,		HUNDSBUAH_MAX_CPU_FREQUENCY ),
	CPU_DVFS("cpu_g", 4,  1, MHZ,  475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850,		HUNDSBUAH_MAX_CPU_FREQUENCY ),
	CPU_DVFS("cpu_g", 4,  2, MHZ,  475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850,		HUNDSBUAH_MAX_CPU_FREQUENCY ),
	CPU_DVFS("cpu_g", 4,  3, MHZ,  475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850,		HUNDSBUAH_MAX_CPU_FREQUENCY ),

	CPU_DVFS("cpu_g", 5,  3, MHZ,  475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850,		HUNDSBUAH_MAX_CPU_FREQUENCY ),
	CPU_DVFS("cpu_g", 5,  4, MHZ,  475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850,		HUNDSBUAH_MAX_CPU_FREQUENCY ),

	CPU_DVFS("cpu_g", 6,  3, MHZ,  475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850,		HUNDSBUAH_MAX_CPU_FREQUENCY ),
	CPU_DVFS("cpu_g", 6,  4, MHZ,  475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850,		HUNDSBUAH_MAX_CPU_FREQUENCY ),

	CPU_DVFS("cpu_g", 12, 3, MHZ,  475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850,		HUNDSBUAH_MAX_CPU_FREQUENCY ),
	CPU_DVFS("cpu_g", 12, 4, MHZ,  475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850,		HUNDSBUAH_MAX_CPU_FREQUENCY ),
...
static struct dvfs cpu_0_dvfs_table[] = {
	/* Cpu voltages (mV):	       762,     825,     875,     925,     950,     1000,    1050,    1100,   1212,    1237,		1375,    HUNDSBUAH_MAX_CPU_VOLTAGE }; */
	CPU_DVFS("cpu_0", 4, 0, MHZ,   475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850,		HUNDSBUAH_MAX_CPU_FREQUENCY ),
	CPU_DVFS("cpu_0", 4, 1, MHZ,   475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850,		HUNDSBUAH_MAX_CPU_FREQUENCY ),
	CPU_DVFS("cpu_0", 4, 2, MHZ,   475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850,		HUNDSBUAH_MAX_CPU_FREQUENCY ),
	CPU_DVFS("cpu_0", 4, 3, MHZ,   475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850,		HUNDSBUAH_MAX_CPU_FREQUENCY ),

	CPU_DVFS("cpu_0", 5, 3, MHZ,   475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850,		HUNDSBUAH_MAX_CPU_FREQUENCY ),
	CPU_DVFS("cpu_0", 5, 4, MHZ,   475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850,		HUNDSBUAH_MAX_CPU_FREQUENCY ),

	CPU_DVFS("cpu_0", 6, 3, MHZ,   475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850,		HUNDSBUAH_MAX_CPU_FREQUENCY ),
	CPU_DVFS("cpu_0", 6, 4, MHZ,   475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850,		HUNDSBUAH_MAX_CPU_FREQUENCY ),

	CPU_DVFS("cpu_0", 12, 3, MHZ,  475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850,		HUNDSBUAH_MAX_CPU_FREQUENCY ),
	CPU_DVFS("cpu_0", 12, 4, MHZ,  475,     620,     760,     910,     1000,    1150,    1300,    1400,   1500,    1700,    1850,		HUNDSBUAH_MAX_CPU_FREQUENCY ),
};
...
static struct dvfs core_dvfs_table[] = {
	/* Core voltages (mV):		  	   950,    1000,   1050,   1100,   1150,    1200,    1250,    1350,    HUNDSBUAH_MAX_CORE_VOLTAGE } */
	...
	CORE_DVFS("vde",    2, 1, KHZ,   200000, 247000, 304000, 352000, 400000,  437000,  484000,  600000, HUNDSBUAH_MAX_CORE_FREQUENCY * 1000 ),
	CORE_DVFS("mpe",    2, 1, KHZ,   200000, 247000, 304000, 361000, 408000,  446000,  484000,  600000, HUNDSBUAH_MAX_CORE_FREQUENCY * 1000 ),
	CORE_DVFS("2d",     2, 1, KHZ,   200000, 267000, 304000, 361000, 408000,  446000,  484000,  600000, HUNDSBUAH_MAX_CORE_FREQUENCY * 1000 ),
	CORE_DVFS("epp",    2, 1, KHZ,   200000, 267000, 304000, 361000, 408000,  446000,  484000,  600000, HUNDSBUAH_MAX_CORE_FREQUENCY * 1000 ),
	CORE_DVFS("3d",     2, 1, KHZ,   200000, 247000, 304000, 361000, 408000,  446000,  484000,  600000, HUNDSBUAH_MAX_CORE_FREQUENCY * 1000 ),
	CORE_DVFS("3d2",    2, 1, KHZ,   200000, 247000, 304000, 361000, 408000,  446000,  484000,  600000, HUNDSBUAH_MAX_CORE_FREQUENCY * 1000 ),
	CORE_DVFS("se",     2, 1, KHZ,   200000, 267000, 304000, 361000, 408000,  446000,  484000,  600000, HUNDSBUAH_MAX_CORE_FREQUENCY * 1000 ),
	CORE_DVFS("host1x", 2, 1, KHZ,   100000, 152000, 188000, 222000, 254000,  267000,  267000,  300000, 350000),
	CORE_DVFS("cbus",   2, 1, KHZ,   200000, 247000, 304000, 352000, 400000,  437000,  484000,  600000, HUNDSBUAH_MAX_CORE_FREQUENCY * 1000 ),
	CORE_DVFS("pll_c",  -1, 1, KHZ,  533000, 667000, 667000, 800000, 800000, 1066000, 1066000, 1200000, HUNDSBUAH_MAX_CORE_FREQUENCY * 1000 * 2 ),
		     ...
		     const char *buf, size_t count)
{
	...
	if( project_id == TEGRA3_PROJECT_TF700T || project_id == TEGRA3_PROJECT_P1801)
	{
		...
		level = HUNDSBUAH_CORE_VOLTAGE_CAP;
	}
	mutex_lock(&core_cap_lock);
