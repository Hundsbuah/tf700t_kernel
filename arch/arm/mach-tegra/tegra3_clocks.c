...
static struct clk_pll_freq_table tegra_pll_c_freq_table[] = {
#if 0 /* For later overclocking  */
   /* 750MHz GPU */
	{ 12000000, 1500000000, 750,   6,  1, 8},
	{ 13000000, 1500000000, 1500, 13,  1, 8},
   ...
   { 12000000, 1450000000, 725,   6,  1, 8},
	{ 13000000, 1450000000, 1450, 13,  1, 8},
	{ 16800000, 1450000000, 1122, 13,  1, 8},	/* actual: 1449969230 Hz */
	{ 19200000, 1450000000, 1888, 25,  1, 8},	/* actual: 1449984000 Hz */
	{ 26000000, 1450000000, 725,  13,  1, 8},

#if 0
   /* 700MHz GPU */
   { 12000000, 1400000000, 700,   6,  1, 8},
	{ 13000000, 1400000000, 1400, 13,  1, 8},
   ...
   /* 600MHz GPU */
	...
	{ 16800000, 1040000000, 1300, 21, 1, 8},
	{ 19200000, 1040000000, 325,   6, 1, 6},
	{ 26000000, 1040000000, 520,  13, 1, 8},

	{ 12000000, 832000000, 416,   6, 1, 8},
	{ 13000000, 832000000, 832,  13, 1, 8},
	{ 16800000, 832000000, 1040, 21, 1, 8},
	...
	{ 16800000, 520000000, 650, 21, 1, 8},
	{ 19200000, 520000000, 325, 12, 1, 6},
	{ 26000000, 520000000, 520, 26, 1, 8},

	{ 12000000, 416000000, 416, 12, 1, 8},
	{ 13000000, 416000000, 416, 13, 1, 8},
	{ 16800000, 416000000, 512, 21, 1, 8},
...
static struct clk tegra_pll_c = {
	...
	.max_rate  = ( HUNDSBUAH_MAX_CORE_FREQUENCY_CAP * 1000000 * 2 ),
	.u.pll = {
		.input_min = 2000000,
		.input_max = 31000000,
		.cf_min    = 1000000,
		.cf_max    = 6000000,
		.vco_min   = 20000000,
		.vco_max   = ( HUNDSBUAH_MAX_CORE_FREQUENCY_CAP * 1000000 * 2 ),
...
static struct clk tegra_pll_c_out1 = {
	...
	.reg       = 0x84,
	.reg_shift = 0,
	.max_rate  = ( HUNDSBUAH_MAX_CORE_FREQUENCY_CAP * 1000000 ),
};
...
static struct clk_pll_freq_table tegra_pll_x_freq_table[] = {
	...
	{ 13000000, 2100000000, 2100, 13, 1, 8},	
	{ 16800000, 2100000000, 250,   2, 1, 8},	
	{ 19200000, 2100000000, 875,   8, 1, 8},	
	{ 26000000, 2100000000, 1050, 13, 1, 8},
    
	/* 2.05 GHz */
	{ 12000000, 2050000000, 1025,  6, 1, 8},
	{ 13000000, 2050000000, 2050, 13, 1, 8},	
	{ 16800000, 2050000000, 1586, 13, 1, 8},      /* actual: 2049600000 Hz */	
	{ 19200000, 2050000000, 2776, 26, 1, 8},      /* actual: 2049969230 Hz */	
	{ 26000000, 2050000000, 1025, 13, 1, 8},
   
    /* 2.0 GHz */
	{ 12000000, 2000000000, 500,   3, 1, 8},
	{ 13000000, 2000000000, 2000, 13, 1, 8},	
	{ 16800000, 2000000000, 2500, 21, 1, 8},	
	...
	{ 16800000, 1950000000, 1625, 14, 1, 8},	
	{ 19200000, 1950000000, 1625, 16, 1, 8},	
	{ 26000000, 1950000000, 150,   2, 1, 8},
	
    /* 1.9 GHz */
	{ 12000000, 1900000000, 950,  6,  1, 8},
	{ 13000000, 1900000000, 1900, 13, 1, 8},	
	{ 16800000, 1900000000, 2375, 21, 1, 8},	
	{ 19200000, 1900000000, 2375, 24, 1, 8},	
	{ 26000000, 1900000000, 950,  13, 1, 8}, 
   
   /* 1.875 GHz */
	{ 12000000, 1875000000,  625,  4, 1, 8},
	{ 13000000, 1875000000, 1875, 13, 1, 8},	
	{ 16800000, 1875000000, 3125, 28, 1, 8},	
	{ 19200000, 1875000000, 2539, 26, 1, 8},	
	{ 26000000, 1875000000, 1875, 26, 1, 8},

   /* 1.85 GHz */
	{ 12000000, 1850000000, 925 , 6,  1, 8},
	{ 13000000, 1850000000, 1850, 13, 1, 8},	
	{ 16800000, 1850000000, 1872, 17, 1, 8},	
	{ 19200000, 1850000000, 1638, 17, 1, 8},	
	{ 26000000, 1850000000, 925,  13, 1, 8},
	
	/* 1.7 GHz */
	{ 12000000, 1700000000, 850,   6,  1, 8},
	{ 13000000, 1700000000, 1700, 13,  1, 8},
	{ 16800000, 1700000000, 2125, 21,  1, 8},
	{ 19200000, 1700000000, 2125, 24,  1, 8},
	{ 26000000, 1700000000, 850,  13,  1, 8},

	/* 1.6 GHz */
	{ 12000000, 1600000000, 800,   6,  1, 8},
	{ 13000000, 1600000000, 1600, 13,  1, 8},
	{ 16800000, 1600000000, 2000, 21,  1, 8},
	...
	{ 16800000, 1300000000, 1625, 21, 1, 8},
	{ 19200000, 1300000000, 1625, 24, 1, 8},
	...
	{ 13000000, 1100000000, 1100, 13, 1, 8},
	{ 16800000, 1100000000, 1375, 21, 1, 8},
	{ 19200000, 1100000000, 1375, 24, 1, 8},
	{ 26000000, 1100000000, 550,  13, 1, 8},

	/* 1 GHz */
	{ 12000000, 1000000000, 1000, 12, 1, 8},
	{ 13000000, 1000000000, 1000, 13, 1, 8},
	{ 16800000, 1000000000, 1250, 21, 1, 8},
	{ 19200000, 1000000000, 625,  12, 1, 8},
...
static struct clk tegra_pll_x = {
	...
	.reg       = 0xe0,
	.parent    = &tegra_pll_ref,
	.max_rate  = ( HUNDSBUAH_MAX_CPU_FREQUENCY_CAP * 1000000 ),
	.u.pll = {
		.input_min = 2000000,
		.input_max = 31000000,
		.cf_min    = 1000000,
		.cf_max    = 6000000,
		.vco_min   = 20000000,
		.vco_max   = ( HUNDSBUAH_MAX_CPU_FREQUENCY_CAP * 1000000 ),
...
struct clk tegra_list_clks[] = {
	...
	PERIPH_CLK("vde",	"vde",			NULL,	61,	0x1c8,	( HUNDSBUAH_MAX_CORE_FREQUENCY_CAP * 1000000 ), mux_pllp_pllc_pllm_clkm,	MUX | DIV_U71 | DIV_U71_INT),
	...
	PERIPH_CLK("mipi",	"mipi",			NULL,	50,	0x174,	70000000,  mux_pllp_pllc_pllm_clkm,	MUX | DIV_U71 | PERIPH_ON_APB), /* scales with voltage */
	...
	PERIPH_CLK("3d",	"3d",			NULL,	24,	0x158,	( HUNDSBUAH_MAX_CORE_FREQUENCY_CAP * 1000000 ), mux_pllm_pllc_pllp_plla,	MUX | DIV_U71 | DIV_U71_INT | DIV_U71_IDLE | PERIPH_MANUAL_RESET),
	PERIPH_CLK("3d2",       "3d2",			NULL,	98,	0x3b0,	( HUNDSBUAH_MAX_CORE_FREQUENCY_CAP * 1000000 ), mux_pllm_pllc_pllp_plla,	MUX | DIV_U71 | DIV_U71_INT | DIV_U71_IDLE | PERIPH_MANUAL_RESET),
	PERIPH_CLK("2d",	"2d",			NULL,	21,	0x15c,	( HUNDSBUAH_MAX_CORE_FREQUENCY_CAP * 1000000 ), mux_pllm_pllc_pllp_plla,	MUX | DIV_U71 | DIV_U71_INT | DIV_U71_IDLE),
	PERIPH_CLK("epp",	"epp",			NULL,	19,	0x16c,	( HUNDSBUAH_MAX_CORE_FREQUENCY_CAP * 1000000 ), mux_pllm_pllc_pllp_plla,	MUX | DIV_U71 | DIV_U71_INT),
	PERIPH_CLK("mpe",	"mpe",			NULL,	60,	0x170,	( HUNDSBUAH_MAX_CORE_FREQUENCY_CAP * 1000000 ), mux_pllm_pllc_pllp_plla,	MUX | DIV_U71 | DIV_U71_INT),
	PERIPH_CLK("host1x",	"host1x",		NULL,	28,	0x180,	350000000, mux_pllm_pllc_pllp_plla,	MUX | DIV_U71 | DIV_U71_INT),
	...
	PERIPH_CLK("se",	"se",			NULL,	127,	0x42c,	( HUNDSBUAH_MAX_CORE_FREQUENCY_CAP * 1000000 ), mux_pllp_pllc_pllm_clkm,	MUX | DIV_U71 | DIV_U71_INT | PERIPH_ON_APB),
...
static struct cpufreq_frequency_table freq_table_1p875GHz[] = {
	{ 0,   51000 },
	{ 1,  102000 },
	{ 2,  204000 },
	{ 3,  370000 },
...
static struct cpufreq_frequency_table freq_table_2p05GHz[] = {
	{ 0,   51000 },
	{ 1,  102000 },
	{ 2,  204000 },
	{ 3,  370000 },
...
static struct cpufreq_frequency_table freq_table_2p1GHz[] = {
	{ 0,   51000 },
	{ 1,  102000 },
	{ 2,  204000 },
	{ 3,  370000 },
