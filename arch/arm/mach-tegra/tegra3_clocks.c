...
static struct clk_pll_freq_table tegra_pll_c_freq_table[] = {
   ...
   /* 600MHz GPU */
	...
	{ 16800000, 1040000000, 557,   9, 1, 8},
	{ 19200000, 1040000000, 325,   6, 1, 6},
	{ 26000000, 1040000000, 520,  13, 1, 8},

	{ 12000000, 832000000, 416,   6, 1, 8},
	{ 13000000, 832000000, 832,  13, 1, 8},
	{ 16800000, 832000000, 445,   9, 1, 8},
...
static struct clk_pll_freq_table tegra_pll_x_freq_table[] = {
   ...
   /* 1.85 GHz */
	...
	{ 13000000, 1850000000, 996,  7,  1, 8},	
	{ 16800000, 1850000000, 991,  9,  1, 8},	
...
static struct clk tegra_pll_x_out0 = {
	...
	.flags     = DIV_2 | PLLX,
	.parent    = &tegra_pll_x,
	.max_rate  = ( HUNDSBUAH_MAX_CPU_FREQUENCY_CAP * 1000000 / 2),
};
...
struct clk tegra_list_clks[] = {
	...
	PERIPH_CLK("host1x",	"host1x",		NULL,	28,	0x180, ( HUNDSBUAH_MAX_HOST1X_FREQUENCY_CAP * 1000000 ), mux_pllm_pllc_pllp_plla,	MUX | DIV_U71 | DIV_U71_INT),
 ...
 * exceeds max dvfs level for LP CPU clock at TEGRA_EMC_BRIDGE_MVOLTS_MIN (1200), the
 * respective emc rate should be above TEGRA_EMC_BRIDGE_RATE_MIN (300000000)
 */
...
unsigned long tegra_emc_to_cpu_ratio(unsigned long cpu_rate)
{
   ...
   if (cpu_rate >= 450000)
		return emc_max_rate;	/* cpu >= 450 MHz, emc max/2 */
	else if (cpu_rate >= 250000)
		return 102000000;	/* cpu >= 250 MHz, emc 100 MHz */
	else
		return 0;		/* emc min */
}
