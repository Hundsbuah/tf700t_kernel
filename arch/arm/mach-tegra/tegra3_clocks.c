...
static int tegra3_pll_clk_set_rate(struct clk *c, unsigned long rate)
{
	...
	if (sel->input_rate == 0) {
		...
		// code flow would not run into here, just leave as a record how to calculate divM, divN
		if(!strcmp(c->name, "pll_d") && ( tegra3_get_project_id() == TEGRA3_PROJECT_TF300TG ) && cn_vf_sku) {
...
static struct clk tegra_pll_c = {
	...
	.max_rate  = ( HUNDSBUAH_CORE_FREQUENCY_CAP * 1000000 * 2 ) + 100000000,
	.u.pll = {
		.input_min = 2000000,
		.input_max = 31000000,
		.cf_min    = 1000000,
		.cf_max    = 6000000,
		.vco_min   = 20000000,
		.vco_max   = ( HUNDSBUAH_CORE_FREQUENCY_CAP * 1000000 * 2 ) + 100000000,
...
static struct clk tegra_pll_c_out1 = {
	...
	.reg       = 0x84,
	.reg_shift = 0,
	.max_rate  = ( HUNDSBUAH_CORE_FREQUENCY_CAP * 1000000 ) + 100000000,
};
...
static struct clk tegra_clk_cclk_lp = {
	...
	.reg	= 0x370,
	.ops	= &tegra_super_ops,
	.max_rate = ( HUNDSBUAH_CPU_LP_FREQUENCY_CAP * 1000000 ), 
};
...
struct clk tegra_list_clks[] = {
	...
	PERIPH_CLK("se",	"se",			NULL,	127,	0x42c,	( HUNDSBUAH_CORE_FREQUENCY_CAP * 1000000 ) + 25000000, mux_pllp_pllc_pllm_clkm,	MUX | DIV_U71 | DIV_U71_INT | PERIPH_ON_APB),
...
unsigned long tegra_emc_to_cpu_ratio(unsigned long cpu_rate)
{
   ...
   if (cpu_rate >= 475000)
		return emc_max_rate;	/* cpu >= 475 MHz, emc_max_rate */
	else if (cpu_rate >= 250000)
		return 102000000;	/* cpu >= 250 MHz, emc 102 MHz */
	else
		return 0;		/* emc min */
}
